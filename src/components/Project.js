...
export default function Project() {
  const project = [
    {
      id: 1,
      title: "Weather App",
      descrption: "A react app to check the weather.",
    ...
    },
    {
      ...
      descrption: "A react app to check the weather.",
      link: "https://example.com",
      technologies: ["React", "OpenWeather API", "MongoDB"],
    },
    {
      id: 3,
      ...
      descrption: "A react app to check the weather.",
      link: "https://example.com",
      technologies: ["React", "OpenWeather API", "Responsive"],
    },
    {
      id: 4,
  ...
  return (
    <div className="min-h-screen w-ful bg-gradient-to-b from-white to-gray-50 py-16">
